...
export const ExpertDetailView: React.FC<ExpertDetailViewProps> = ({ 
  ...
  const handleNextReview = () => {
    setCurrentReviewIndex((prevIndex) => 
      prevIndex === expert.reviews.length - 1 ? 0 : prevIndex + 1
    );
  };

  const handlePreviousReview = () => {
    setCurrentReviewIndex((prevIndex) => 
      prevIndex === 0 ? expert.reviews.length - 1 : prevIndex - 1
    );
  };
    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-4xl max-h-[95vh] overflow-hidden p-0">
          <div className="flex flex-col h-full max-h-[95vh]">
            <DialogHeader className="px-6 pt-6 pb-2 border-b sticky top-0 z-10 bg-background">
            ...
            <div className="flex-1 overflow-hidden">
              <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
                <div className="px-6 border-b sticky top-[76px] z-10 bg-background">
                  <ScrollArea className="w-full">
                    <TabsList className="h-12 w-full justify-start pb-px">
                ...
                <div className="flex-1 overflow-hidden">
                  <TabsContent value="profile" className="h-full data-[state=active]:h-full m-0 border-none">
                    <ScrollArea className="h-full p-6 pb-16">
                            ...
                            <CardHeader className="flex flex-row items-center justify-between pb-2">
                              ...
                              <div className="flex items-center">
                                <Button 
                                  ...
                                  disabled={expert.reviews.length <= 1}
                                >
                                  ...
                                  <div className="flex justify-between items-start">
                                    <div className="flex items-center">
                                      <Avatar className="h-6 w-6 mr-2">
                                        {expert.reviews[currentReviewIndex].avatar ? (
                                          <AvatarImage src={expert.reviews[currentReviewIndex].avatar} alt={expert.reviews[currentReviewIndex].name} />
                                        ) : (
                                          <AvatarFallback>{expert.reviews[currentReviewIndex].name.substring(0, 2).toUpperCase()}</AvatarFallback>
                                        )}
                                      </Avatar>
                                      <span className="font-medium text-sm">{expert.reviews[currentReviewIndex].name}</span>
                                    </div>
                                    <StarRating rating={expert.reviews[currentReviewIndex].rating} />
                                  </div>
                                  <p className="text-sm mt-2">{expert.reviews[currentReviewIndex].comment}</p>
                                  <div className="flex justify-between items-center mt-2 text-xs text-muted-foreground">
                                    <span>{expert.reviews[currentReviewIndex].date}</span>
                                    {expert.reviews[currentReviewIndex].verified && (
                  ...
                  <TabsContent value="reviews" className="h-full data-[state=active]:h-full m-0 border-none">
                    <ScrollArea className="h-full p-6 pb-16">
                      <Card>
                        <CardHeader>
                  ...
                  <TabsContent value="achievements" className="h-full data-[state=active]:h-full m-0 border-none">
                    <ScrollArea className="h-full p-6 pb-16">
                      <Card>
                        <CardHeader>
                  ...
                  <TabsContent value="cases" className="h-full data-[state=active]:h-full m-0 border-none">
                    <ScrollArea className="h-full p-6 pb-16">
                      <Card>
                        <CardHeader>
                  ...
                  <TabsContent value="availability" className="h-full data-[state=active]:h-full m-0 border-none">
                    <ScrollArea className="h-full p-6 pb-16">
                      <Card>
                        <CardHeader>
      ...
      <Dialog open={bookingOpen} onOpenChange={setBookingOpen}>
        <DialogContent className="max-w-md max-h-[90vh]">
          <DialogHeader>
            <DialogTitle>Book an Appointment with {expert.name}</DialogTitle>
            <DialogDescription>
            ...
            <AppointmentBooking 
              ...
              onSuccess={async () => {
                ...
                toast({
                  ...
                  description: `Your appointment with ${expert.name} has been scheduled.`,
                });
